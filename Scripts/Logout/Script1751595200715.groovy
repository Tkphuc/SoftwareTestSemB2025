...
WebUI.click(findTestObject('Object Repository/Logout/Page_Swag Labs/div_Swag Labs_login_button_container'))

WebUI.click(findTestObject('Object Repository/Logout/Page_Swag Labs/div_Swag Labs_login_wrapper-inner'))

WebUI.click(findTestObject('Object Repository/Logout/Page_Swag Labs/div_Accepted usernames arestandard_userlock_0d4679'))

WebUI.verifyElementVisible(findTestObject('Logout/Page_Swag Labs/div_Accepted usernames arestandard_userlock_0d4679'))
